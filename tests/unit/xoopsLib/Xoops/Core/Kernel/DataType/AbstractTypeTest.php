...
class AbstractTypeTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->object = $this->getMockForAbstractClass('\Xoops\Core\Kernel\DataType\AbstractType');
        $this->reflectedObject = new \ReflectionClass('\Xoops\Core\Kernel\DataType\AbstractType');
    }
